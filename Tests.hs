...
test_blake256 = 
    TestCase $ do
        ...
        assertEqual "BLAKE-256 of 72 by '0x00'" 
            (toByteString 32 ([0xD419BAD3, 0x2D504FB7, 0xD44D460C, 0x42C5593F, 
                               0xE544FA4C, 0x135DEC31, 0xE21BD9AB, 0xDCC22D41] :: [Word32]))
...
test_blake224 = 
    TestCase $ do
        assertEqual "BLAKE-224 of '0x00'"
            (toByteString 32 ([0x4504CB03, 0x14FB2A4F, 0x7A692E69, 0x6E487912, 
                               0xFE3F2468, 0xFE312C73, 0xA5278EC5] :: [Word32]))
            (blake224 (zeroByteString 16) (B.pack [0])) 

        assertEqual "BLAKE-224 of 72 by '0x00'" 
            (toByteString 32 ([0xF5AA00DD, 0x1CB847E3, 0x140372AF, 0x7B5C46B4, 
                               0x888D82C8, 0xC0A91791, 0x3CFB5D04] :: [Word32]))
